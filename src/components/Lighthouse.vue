    ...
    <v-container fluid>
        ...
        <v-container fill-height>
          <v-layout align-center>
            <v-flex>
              ...
              <span class="subheading">Thanks for visiting the <strong>Lighthouse Crawler</strong>, your number one stop for information about Washington lighthouses.
              ...
              <v-select v-model="featuredLighthouse" :items="lighthouses" label="Select a lighthouse " item-value="featured" item-text="itemLabel"
                solo return-object>
              </v-select>
            </v-flex>
          </v-layout>
      ...
      <v-container grid-list-xs v-if="featuredLighthouse">
        <v-layout>
          ...
          <a target="_blank" :href="getDirectionsURL">
            Get Directions
          </a>          
